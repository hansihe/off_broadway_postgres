defmodule OffBroadwayPostgres.Migration do
  # Migration approach largely copied from https://github.com/sorentwo/oban
  use Ecto.Migration
  ...
  def migrated_version(opts) do
    ...
    WHERE pg_class.relname = 'off_broadway_postgres_jobs'
  ...
  defp record_version(%{prefix: prefix}, version) do
    execute "COMMENT ON TABLE #{inspect(prefix)}.off_broadway_postgres_jobs IS '#{version}'"
  end
